...
#   Note: need to be in the working directory or specify the path! getwd() 
...
# different way of sequence definition for X and Y
f1 + scale_x_continuous(limits = c(0,500), breaks = c(seq(0,500,50))) +
...
# 1) add a line as the mean using the segment attribute
# we need to define the coordinates of the red line (2 points)
yval = 60
